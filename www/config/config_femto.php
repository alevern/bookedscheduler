...
$conf['settings']['app.title'] = 'Booked FEMTO-ST';
$conf['settings']['default.timezone'] = 'Europe/Paris';
$conf['settings']['allow.self.registration'] = 'false';
$conf['settings']['admin.email'] = 'sci@femto-st.fr';
$conf['settings']['admin.email.name'] = 'SCI';
$conf['settings']['default.page.size'] = '50';
$conf['settings']['enable.email'] = 'true';
$conf['settings']['default.language'] = 'fr_fr';
$conf['settings']['script.url'] = 'https://booked.femto-st.fr/Web';
...
$conf['settings']['privacy']['view.schedules.filter'] = 'Pôle S.MART;CMI imprimantes 3D;DMA';
...
$conf['settings']['database']['password'] = 'W7jj8@W@';
...
$conf['settings']['plugins']['Authentication'] = 'LdapAddGroup';
...
$conf['settings']['install.password'] = '5a1bf0357848f';
...
$conf['settings']['email']['default.from.address'] = 'noreply@booked.femto-st.fr';
$conf['settings']['email']['default.from.name'] = 'Booked@FEMTO-ST';
